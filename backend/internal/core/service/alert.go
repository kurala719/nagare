...
func SearchAlertsServ(filter domain.AlertFilter) ([]AlertRes, error) {
...
func CountAlertsServ(filter domain.AlertFilter) (int64, error) {
...
func analyzeAndNotifyAlert(alert domain.Alert) {
...
func analyzeAlertWithAI(alert domain.Alert) (string, error) {
...
func UpdateAlertServ(id int, req AlertReq) error {
	...
	return repository.UpdateAlertDAO(id, domain.Alert{
		Message:  req.Message,
		Severity: req.Severity,
		Status:   alert.Status,
		AlarmID:  req.AlarmID,
