...
func SubmitPasswordResetApplicationServ(username, password string) error {
	...
	app := domain.PasswordResetApplication{
		UserID:      user.ID,
		Username:    username,
...
func ListPasswordResetApplicationsServ(filter domain.RegisterApplicationFilter) ([]PasswordResetApplicationResponse, error) {
...
func CountPasswordResetApplicationsServ(filter domain.RegisterApplicationFilter) (int64, error) {
