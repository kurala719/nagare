...
func checkMonitorStatus(monitor domain.Monitor) StatusCheckResult {
...
func checkProviderStatus(provider domain.Provider) StatusCheckResult {
...
func checkGroupStatus(group domain.Group) StatusCheckResult {
