...
func ListRegisterApplicationsServ(filter domain.RegisterApplicationFilter) ([]RegisterApplicationResponse, error) {
...
func CountRegisterApplicationsServ(filter domain.RegisterApplicationFilter) (int64, error) {
