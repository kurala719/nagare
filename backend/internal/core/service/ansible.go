...
func UpdatePlaybookServ(id uint, req PlaybookReq) error {
	return repository.UpdatePlaybookDAO(id, domain.AnsiblePlaybook{
		Name:        req.Name,
		Description: req.Description,
		Content:     req.Content,
		Tags:        req.Tags,
...
func playbookToResp(pb domain.AnsiblePlaybook) PlaybookResp {
	return PlaybookResp{
		ID:          pb.ID,
		Name:        pb.Name,
...
func jobToResp(job domain.AnsibleJob) AnsibleJobResp {
